...
\begin{cu}{\jugcr}
	...
	\begin{cursoe}{}
		...
		\paso{1 Si el \jucr desea apuesta. \exti{\apocr} }{}
		
		\paso{2 Si es su turno el sistema pregunta si desea tirar los dados. Sino ir a 5}{2.1 Error: La apuesta no es valida por falta de saldo. Ir a 4}%lo mande a ese paso xq si era el unico jugador
		%y no tiene saldo el sistema va a mostrar un resultado "nulo" hasta q se aburra
		\paso{3 Si el jugador desea tirar los dados entonces tira los dados}{3.1 Si el jugador no desea tirar los dados y no hay otro jugador en la mesa Error: El \jucr debe tirar los dados porque no hay otro jugador en la mesa. Ir a 2}
		
		\paso{4 El sistema informa si la jugada es normal, feliz o todos ponen}{}
					
		\paso{5 El sistema muestra los resultados del tiro}{}
		
	  \paso{6 Si el \jucr ha ganado alguna apuesta el sistema acredita el premio correspondiente}{}
	  
	  \paso{7 El sistema modifica el saldo del \jucr si corresponde}{}
...
\begin{cu}{\apocr}
	...
	\begin{cursoe}{}
    \paso{1 El \apcr elige un tipo de apuesta }{}
...
%Con esto quiero decir que si no se ha fijado ya el punto entonces ciertos tipos de apuestas no serán válidos para esta jugada
    ...
    \paso{3 El \apcr selecciona de entre sus fichas disponibles un monto a apostar}{}
		
		\paso{4 Si el \apcr no es VIP el sistema verifica si tiene saldo suficiente para la apuesta}{}
			
		\paso{5 El sistema valida la apuesta y descuenta el monto del saldo del jugador}{5.1 Error: El sistema informa que no tiene saldo suficiente para realizar esta apuesta. Ir a 8}
				
		\paso{6 Si el jugador desea realizar otra apuesta ir a paso 1 }{}
		
		\paso{7 El sitema actualiza y muestra el estado de cuenta del jugador }{}	
