...
La forma en que un cliente ingresa o egresa del casino esta explicado en los siguientes  casos de uso:
...
\begin{flushleft}
\begin{itemize}
	\item Un invitado podrá observar los juegos pero sin participar en ellos: Puede ingresar en una mesa ya abierta y observar el desarrollo del juego pero sin intervenir en el \label{1c}
\end{itemize}
\end{flushleft}	
