...
\begin{center}
		\includegraphics[scale=0.3]{img/dclCasino.png}
\end{center}
...
self.ApuestasTragamonedas->exists(a | a.estado = EstadoAp::Activa)
    implies not(self.participaEn = <undefined>)
...
(self.estadoMesa = EstadoMesa::Abierta) implies 
    not(self.jugadorParticipando = <undefined>) and
(self.estadoMesa = EstadoMesa::Cerrada) implies 
    self.jugadorParticipando = <undefined>
...
self.ApuestasTragamonedas->
    ...
    a.JugadaTragamonedas.mesaTragamonedas = self.participaEn)
