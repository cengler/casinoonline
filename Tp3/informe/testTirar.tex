...
4	&	ERROR: No se podran lanzar los dados, un observador no puede tirar en el juego craps\\
...
14	&	OK, se han tirado los dados, no hay apuesta para pagar ni jugadas seteadas\\
15	&	OK, se han tirado los dados, la jugada es de tipo normal. (Se estudiará en el caso de test de la apuesta correspondiente)\\
16	&	OK, se han tirado los dados, la jugada es de tipo normal, ha salido el valor dirigido, un craps, el jugador ha perdido la apuesta Pase, por lo que ya no esta vigente. Ha finalizado la ronda y el jugador pasará los dados\\
17	&	OK, se han tirado los dados, la jugada es de tipo normal, se ha establecido el punto con el valor dirigido, el puck ha sido encendido. La apuesta no se ha resuelto, continuara vigente. La ronda continua y el jugador continuara tirando\\
18	&	OK, se han tirado los dados, la jugada es de tipo normal, el resultado es el valor dirigido: 7. El jugador ha ganado la apuesta Pase, por lo que ya no esta vigente. La apuesta pagara el doble del monto apostado, descontando este valor del saldo del casino y acreditandolo en el del jugador. La ronda ha terminado y el jugador continuara tirando\\
\hline
\end{tabularx}

\begin{tabularx}{1\textwidth}{|p{1cm}|X|}
\hline
19	&	OK, se han tirado los dados, la jugada es de tipo normal, se ha establecido el punto con el valor dirigido: 8, el puck ha sido encendido. La apuesta no se ha resuelto, continuara vigente. La ronda continua y el jugador continuara tirando\\
20	&	OK, se han tirado los dados, la jugada es de tipo normal, ha salido el valor dirigido: 12, un craps, el jugador ha perdido la apuesta Pase, por lo que ya no esta vigente. Ha finalizado la ronda y el jugador pasará los dados\\
21	&	OK, se han tirado los dados, la jugada es de tipo normal, el resultado es el valor dirigido: 11. El jugador ha ganado la apuesta Pase, por lo que ya no esta vigente. La apuesta pagara el doble del monto apostado, descontando este valor del saldo del casino y acreditandolo en el del jugador. La ronda ha terminado y el jugador continuara tirando\\
22	&	OK, se han tirado los dados, la jugada es de tipo normal, ha salido el valor dirigido, un craps, El jugador ha ganado la apuesta No Pase. La apuesta pagara el doble del monto apostado, descontando este valor del saldo del casino y acreditandolo en el del jugador. Ha finalizado la ronda y el jugador pasa los dados\\
23	&	OK, se han tirado los dados, la jugada es de tipo normal, se ha establecido el punto con el valor dirigido, el puck ha sido encendido. La apuesta no se ha resuelto, continuara vigente. La ronda continua y el jugador continuara tirando\\
24	&	OK, se han tirado los dados, la jugada es de tipo normal, el resultado es el valor dirigido: 7. el jugador ha perdido la apuesta No Pase. La ronda ha terminado y el jugador continuara tirando\\
25	&	OK, se han tirado los dados, la jugada es de tipo normal, se ha establecido el punto con el valor dirigido: 8, el puck ha sido encendido. La apuesta no se ha resuelto, continuara vigente. La ronda continua y el jugador continuara tirando\\
26	&	OK, se han tirado los dados, la jugada es de tipo normal, ha salido el valor dirigido 12, El jugador ha empatado la apuesta No Pase. La apuesta pagara el mismo valor del monto apostado, descontando este valor del saldo del casino y acreditandolo en el del jugador. Ha finalizado la ronda y el jugador pasará los dados\\
27	&	OK, se han tirado los dados, la jugada es de tipo normal, el resultado es el valor dirigido: 11. el jugador ha perdido la apuesta No Pase. El tirador continua tirando\\
28	&	OK, el tiro no es de salida, la jugada es de tipo normal.\\
29	&	OK, el tiro no es de salida, la jugada es de tipo normal.\\
30	&	OK, se han tirado los dados, la jugada es de tipo normal, no se ha acertado el punto con el valor dirigido, el puck continua encendido. La apuesta no se ha resuelto, continua vigente. La ronda continua y el jugador continuara tirando\\
\hline
\end{tabularx}

\begin{tabularx}{1\textwidth}{|p{1cm}|X|}
\hline
31	&	OK, se han tirado los dados, la jugada es de tipo normal, no se ha acertado el punto con el valor dirigido, el puck continua encendido. La apuesta no se ha resuelto, continua vigente. La ronda continua y el jugador continuara tirando\\
32	&	OK, se han tirado los dados, la jugada es de tipo normal, el resultado es el valor dirigido: 7. No se ha acertado el punto, ha salido un "Seven Out". El jugador ha perdido la apuesta Pase, por lo que ya no esta vigente. La ronda ha terminado, el puck ha sido apagado y el jugador pasa los dados\\
33	&	OK, se han tirado los dados, la jugada es de tipo normal, el resultado es el valor dirigido: 8. Se ha acertado el punto. El jugador ha ganado la apuesta Pase, por lo que ya no esta vigente. La apuesta pagara el doble del monto apostado, descontando este valor del saldo del casino y acreditandolo en el del jugador. La ronda ha terminado, el puck ha sido apagado y el jugador continuara tirando\\
34	&	OK, se han tirado los dados, la jugada es de tipo normal, no se ha establecido el punto con el valor dirigido, el puck continua encendido. La apuesta no se ha resuelto, continua vigente. La ronda continua y el jugador continuara tirando\\
35	&	OK, se han tirado los dados, la jugada es de tipo normal, no se ha establecido el punto con el valor dirigido, el puck continua encendido. La apuesta no se ha resuelto, continua vigente. La ronda continua y el jugador continuara tirando\\
36	&	OK, se han tirado los dados, la jugada es de tipo normal, no se ha establecido el punto con el valor dirigido, el puck continua encendido. La apuesta no se ha resuelto, continua vigente. La ronda continua y el jugador continuara tirando\\
37	&	OK, se han tirado los dados, la jugada es de tipo normal,  no se ha establecido el punto con el valor dirigido, el puck continua encendido. La apuesta no se ha resuelto, continua vigente. La ronda continua y el jugador continuara tirando\\
38	&	OK, se han tirado los dados, la jugada es de tipo normal, el resultado es el valor dirigido: 7. No se ha acertado el punto, ha salido un "Seven Out". El jugador ha ganado la apuesta No pase. La apuesta pagara el doble del monto apostado, descontando este valor del saldo del casino y acreditandolo en el del jugador. La ronda ha terminado, el puck ha sido apagado y el jugador pasa los dados\\
39	&	OK, se han tirado los dados, la jugada es de tipo normal, el resultado es el valor dirigido: 8. Se ha acertado el punto. El jugador ha perdido la apuesta No Pase. La ronda ha terminado, el puck ha sido apagado y el jugador continuará tirando\\
40	&	OK, se han tirado los dados, la jugada es de tipo normal, no se ha establecido el punto con el valor dirigido, el puck continua encendido. La apuesta no se ha resuelto, continua vigente. La ronda continua y el jugador continuara tirando\\
41	&	OK, se han tirado los dados, la jugada es de tipo normal, no se ha establecido el punto con el valor dirigido, el puck continua encendido. La apuesta no se ha resuelto, continua vigente. La ronda continua y el jugador continuara tirando\\
\hline
\end{tabularx}
...
\begin{itemize}
	\item En el comienzo descubrimos que por un error en el parseo de los pagos, nunca se pagaba al casino, sino que siempre se ganaba.
	\item Nos dimos cuenta de un error en el pago de la jugada de empate, que dada la forma que se hacia el calculo, y los datos de configuracion, derivaba en una division por 0.
\end{itemize}
Al finalizar los testeos logramos que todos los test a tirar casino fueran exitosos.