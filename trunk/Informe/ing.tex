...
\begin{cu}{Dando de alta cliente}
	...
	\begin{cursoe}{}
		...
		{3.1 El sistema rechaza al \pc por ser menor de edad. Ir a paso 6}
		
		\pasoa{3.2 El sistema rechaza al \pc porque hay un usuario con el mismo nick. Ir a paso 2}
		
		\pasoa{3.3 El sistema rechaza la creacion del \pc porque hay un usuario con el mismo numero de documento. Ir a paso 6}
		...
		\paso{4 El sistema verificará la existencia de la cuenta corriente ingresada. \incl{Verificando cuenta} }
		{}
		
		\paso{5 Si el \pc lo deseea, ingresa al casino online \exti{Ingresando a casino} }
		{5.1 En caso de que la verificacion sea erronea ir a paso 6}
...
\begin{cu}{\cucf}
	\descripxizq=3cm
		\defln{Este caso de uso explica como un cliente loggeado interactúa con el sistema con el fin de comprar fichas que le permitirán jugar en el casino}
		\actor{\cf}
		\actorsec{\scc}
		\pre{el \cf esta loggeado en el sistema }
		\post{las fichas compradas por el \cf son agregaddas a su \caja}

	\begin{cursoe}{}
	
		\paso{1 El \cf selecciona cuántas fichas de cada tipo desea comprar.}{}
			
		\paso{2 El sistema establece conexión con el \scc.}{}
		
		\paso{3 El sistema transfiere el monto total de la compra desde la cuenta corriente del \cf a la cuenta del casino.}
		{3.1 No se puede establecer la conexión con el \scc. Ir a paso 6.}
		
		\paso{4 El sistema agrega a la \caja del \cf las fichas compradas.}
		{4.1 Los fondos de la cuenta corriente del \cf son insuficientes para realizar la operación. Ir a paso 6}
				
		\paso{5 El sistema notifica al \cf que la operación de compra se realizó exitosamente.}{}
...
\begin{cu}{\cuic}
	\descripxizq=1cm
		...
		\actor{\cl}
		\pre{true }
		\post{El \cl ingresó al casino online}
	...
	\begin{cursoe}{}
		...
		\paso{3 El cliente ingresó al casino}{3.1 Si el nick no existe ir a paso 1}
