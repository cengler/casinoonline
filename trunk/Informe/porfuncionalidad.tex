...
\newpage
Prototipo de pantalla de \inginvi.
\vskip1cm
{\large PANTALLA : Invitado ingresando a mesa como invitado}
\begin{center}
\includegraphics[scale=0.75]{../pantallas/invitado.PNG}
\end{center}
...
\subsection{Seleccion de un juego}

Las siguientes dos secciones \textbf{Juego Tragamonedas} \ref{sjt} y \textbf{Juego Craps} \ref{sjc}, explican la eleccion de un juego de tal tipo y la forma en que se jugará.

Presentamos aqui un prototipo de la pantalla que permitirá seleccionar un juego. Los jugadores que esten dentro del casino y no esten jugando o seleccionando una mesa de algun juego veran esta pantalla.

\vskip1cm
{\large PANTALLA : Dentro del casino}
\begin{center}
\includegraphics[scale=0.75]{../pantallas/dentrodelCasino.PNG}
\end{center}

Notese que aqui tambien se muestra el monto de los posos, ya que existe el objetivo de atraer a los jugadores con el monto de los posos.

\textbf{Esto contribuye al requerimiento:}
\begin{itemize}
\item Mostrar en todo momento el monto de los pozos: En todo momento se mostrara el monto actualizado de todos los pozos del casino, y se actualizará inmediatamente a medida que varie.\label{7a1}
\end{itemize}
...
Presentamos un prototipo de lo que veria un jugador de tragamonedas mientras que juega al tragamonedas.

\vskip1cm
{\large PANTALLA : Jugando al Tragamonedas}
\begin{center}
\includegraphics[scale=0.50]{../pantallas/jugandoTragamonedas.PNG}
\end{center}

\textbf{Esto contribuye a los requerimientos:}

\begin{itemize}
\item Las pantallas mostraran la información necesaria para el desarrollo del juego: Las pantallas mostrarán la interfaz del juego asi como tambien todas las opciones disponibles dentro del juego. \label{3a2}
\item Las pantallas mostraran la información necesaria del estado del juego: Las pantallas mostraran el tipo de jugada, estado actual del juego y resultados, y será inmediatamente actualizada ante cualquier cambio o variación.\label{3b2}  
\item Las pantallas mostraran el estado de la cuenta del jugador: Por pantalla se podrá ver si un jugador esta dentro del casino y dentro de algun juego y si es así en que mesa, si ha resultado ganador o no, y su correspondiente saldo.  \label{3c2}
\end{itemize}
...
\textbf{Aqui se refleja el siguiente requerimiento: }
...
Presentamos aqui tambien un prototipo de pantalla para ilustrar la experiencia del ususario.

\vskip1cm
{\large PANTALLA : Ingresando juego craps}
\begin{center}
\includegraphics[scale=0.75]{../pantallas/ingresandoCraps.PNG}
\end{center}

Se muestra el monto de los pozos asi contrubuimos a sus ganas de jugar.

\textbf{Esto contribuye al requerimiento:}
\begin{itemize}
\item Mostrar en todo momento el monto de los pozos: En todo momento se mostrara el monto actualizado de todos los pozos del casino, y se actualizará inmediatamente a medida que varie.\label{7a2}
\end{itemize}
...
Los CU de \jugcr y \apcr se encontraran disponibles en una misma pantalla de un ``jugador de craps''. Presentamos aqui un prototipo.

\vskip1cm
{\large PANTALLA : Jugando al Craps}
\begin{center}
\includegraphics[scale=0.50]{../pantallas/jugandoCraps.PNG}
\end{center}

\textbf{Esto contribuye a los requerimientos:}

\begin{itemize}
\item Las pantallas mostraran la información necesaria para el desarrollo del juego: Las pantallas mostrarán la interfaz del juego asi como tambien todas las opciones disponibles dentro del juego. \label{3a1}
\item Las pantallas mostraran la información necesaria del estado del juego: Las pantallas mostraran el tipo de jugada, estado actual del juego y resultados, y será inmediatamente actualizada ante cualquier cambio o variación.\label{3b1}  
\item Las pantallas mostraran el estado de la cuenta del jugador: Por pantalla se podrá ver si un jugador esta dentro del casino y dentro de algun juego y si es así en que mesa, si ha resultado ganador o no, y su correspondiente saldo.  \label{3c1}
\end{itemize}
...
Mostramos la interaccion con el sistema en los casos de uso  \ref{pid} Pidiendo Informe Detalles de movimiento por Jugador, \ref{pie} Pidiendo Informe Estado Actual y \ref{pir} Pidiendo Informe Ranking de Jugadores
