...
{\large FSM: Jugada Craps}
\begin{center}
\includegraphics[scale=0.25]{../pantallas/desarrolloCraps.png}
\end{center}

{\large FSM: Jugada Craps}
\begin{center}
\includegraphics[scale=0.25]{../pantallas/jugandoCraps.PNG}
\end{center}

{\large FSM: Jugada Craps}
\begin{center}
\includegraphics[scale=0.25]{../pantallas/invitado.PNG}
\end{center}

{\large FSM: Jugada Craps}
\begin{center}
\includegraphics[scale=0.25]{../pantallas/ingresandoCraps.PNG}
\end{center}

{\large FSM: Jugada Craps}
\begin{center}
\includegraphics[scale=0.25]{img/dentrodelCasino.PNG}
\end{center}
...
\item Mostrar en todo momento el monto de los pozos: En todo momento se mostrara el monto actualizado de todos los pozos del casino, y se actualizará inmediatamente a medida que varie.\label{7a}
\end{itemize}
