...
\begin{center}
	...
	\emph{Author:}\\
		Isis \textsc{Aquino} $313/05$ \hfill \textsl{isisaquino@yahoo.com.ar}\\
		Maria de los Angeles \textsc{Alvarez} $264/05$ \hfill \textsl{mdelosaalvarez@hotmail.com}\\
		Christian Alejandro \textsc{Engler} $314/05$ \hfill \textsl{caeycae@gmail.com}
	\end{flushleft}
\end{center}.\\[2cm]
