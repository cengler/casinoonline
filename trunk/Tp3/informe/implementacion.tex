...
En este archivo se configuran los saldos del casino, tento el saldo coneral como el saldo de los pozos de peremios.\\
...
En este archivos se configuran las fichas validas del casino, el primer valor represnta el id de la ficha y el segundo el valor de la ficha. Los clientes apuestan por id de ficha (esto para tener indireccion con el valor real de las fichas).
...
Main targets:
 ...
 javadoc  Genera reporte de violaciones de convenciones de codigo.
...
En el caso de correr el trabajo desde el directorio jar el archivos de encontrará en: \\
